...
* AdministrativeAreas.shp - Shapefile (vector) showing administrative areas within Tanzania (source [DIVA GIS](https://diva-gis.org/))
...
* Lakes.kml - KML (vector layer) of lakes in Tanzania (source [DIVA GIS](http://diva-gis.org/))
...
[![A video walkthrough of this practical is available here](https://youtu.be/AlZaVZomdww)](https://youtu.be/AlZaVZomdww)
